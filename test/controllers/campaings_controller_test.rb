...
class CampaingsControllerTest < ActionController::TestCase
  ...
  test "should create campaing" do
    assert_difference('Campaing.count') do
      post :create, campaing: { campaingCode: @campaing.campaingCode, campaingName: @campaing.campaingName, status: @campaing.status }
    end
  ...
  test "should update campaing" do
    patch :update, id: @campaing, campaing: { campaingCode: @campaing.campaingCode, campaingName: @campaing.campaingName, status: @campaing.status }
    assert_redirected_to campaing_path(assigns(:campaing))
  end
